...
<div class="body-content">
    ...
    <div class="container content p-4">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="catalog mb-3">
                    <img src="{{ asset('storage/'. $product->catalog) }}" alt="{{ $product->product_name }}" style="width: 100%; height:auto;">
                </div>
            </div>
            <div class="col-lg-4" style="display: flex; flex-direction: column;">
                @foreach ($galleries as $gallery)
                    <div class="card p-3 mb-3" style="box-shadow: 5px 5px 15px rgba(0,0,0,0.2);">
